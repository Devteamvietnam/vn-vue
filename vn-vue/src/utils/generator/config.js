...
export const selectComponents = [
  ...
  {
    label: 'Single selection box group',
    tag: 'el-radio-group',
    tagIcon: 'radio',
    defaultValue: undefined,
    span: 24,
...
// The trigger mode of the component rule, the component without the trigger mode does not generate the rule
