...
// https://github.com/vuejs/vue/blob/v2.6.10/src/platforms/web/server/util.js
...
const componentChild = {
  ...
  'el-upload': {
    'list-type': (h, conf, key) => {
      ...
      if (conf.showTip) {
        list.push(<div slot="tip" class="el-upload__tip">Only upload {conf.accept} files that do not exceed {conf.fileSize}{conf.sizeUnit}</div>)
      }
      return list
    }
  }
