...
<script>
import { getGenTable, updateGenTable } from "@/services/api/tool/gen";
import { optionselect as getDictOptionselect } from "@/services/api/system/dict/type";
import { listMenu as getMenuTreeselect } from "@/services/api/system/menu";
