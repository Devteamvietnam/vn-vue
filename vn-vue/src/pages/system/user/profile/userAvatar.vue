<template>
  <div>
    <div class="user-info-head" @click="editCropper()"><img v-bind:src="options.img" title="Click to upload the avatar" class="img-circle img-lg" /></div>
...
import {uploadAvatar} from "@/services/api/system/user";
export default {
