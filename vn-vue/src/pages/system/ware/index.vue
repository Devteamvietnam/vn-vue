        ...
        >
          <el-form-item label="Code" prop="wareCode">
            <el-input
              ...
              placeholder="Please enter the ware code"
              clearable
              size="small"
          ...
          <el-form-item label="Name" prop="wareName">
            <el-input
              ...
              placeholder="Please enter the name of the ware"
              clearable
              size="small"
              @keyup.enter.native="handleQuery"
            />
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-form-item label="Name" prop="wareName">
          <el-input
            ...
            placeholder="Please enter the ware name"
          />
        </el-form-item>
        <el-form-item label="Code" prop="wareCode">
          <el-input
            v-model="form.wareCode"
            placeholder="Please enter the code name"
          />
        </el-form-item>
        <el-form-item label="Order" prop="wareSort">
          <el-input-number
            v-model="form.wareSort"
...
export default {
    ...
    return {
      ...
      rules: {
        wareName: [
          {
            required: true,
            message: "Ware name cannot be empty",
            trigger: "blur",
          },
        ],
        wareCode: [
          {
            required: true,
            message: "Ware code cannot be empty",
            trigger: "blur",
          },
        ],
        wareSort: [
          {
            required: true,
            message: "The ware sequence cannot be empty",
            trigger: "blur",
          },
        ],
        deptId: [
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listWare(this.addDateRange(this.queryParams, this.dateRange)).then(
        (response) => {
    ...
    // Ware status dictionary translation
    ...
    handleDelete(row) {
      ...
      this.$confirm(
        'Are you sure to delete the data item with the ware number "' +
          wareIds +
          '"?',
        "Warning",
        {
