...
export default {
    ...
    return {
      ...
      rules: {
        postName: [
          {
            required: true,
            message: "Post name cannot be empty",
            trigger: "blur",
          },
        ],
        postCode: [
        ...
        postSort: [
          {
            required: true,
            message: "The post sequence cannot be empty",
            trigger: "blur",
          },
        ],
      },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm(
        'Are you sure to delete the data item with the post number "' +
          postIds +
          '"?',
        "Warning",
        {
