    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item>
          ...
          <treeselect v-model="info.parentMenuId" :append-to-body="true" :options="menus" :normalizer="normalizer" :show-count="true" placeholder="Please select the system menu" />
        </el-form-item>
      </el-col>
      ...
      <el-col :span="12">
        <el-form-item>
          ...
          <el-select v-model="info.treeCode" placeholder="Please select">
            <el-option v-for="column in info.columns" :key="column.columnName" :label="column.columnName + ':' + column.columnComment" :value="column.columnName" />
          </el-select>
        </el-form-item>
      </el-col>
      <el-col :span="12">
