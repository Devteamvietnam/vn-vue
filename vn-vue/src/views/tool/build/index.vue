      ...
      <el-scrollbar class="left-scrollbar">
        <div class="components-list">
          <div class="components-title">
            <svg-icon icon-class="component" />input type component
          </div>
          <draggable
          ...
          <div class="components-title">
            <svg-icon icon-class="component" />Selective component
          </div>
          <draggable
            class="components-draggable"
          ...
          <div class="components-title">
            <svg-icon icon-class="component" /> layout component
          </div>
          <draggable
            class="components-draggable"
...
export default {
  ...
  methods: {
    ...
    cloneComponent(origin) {
      ...
      clone.renderKey = +new Date() // After changing the renderKey, the component can be forced to update
