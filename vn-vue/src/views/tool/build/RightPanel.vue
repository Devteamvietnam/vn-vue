      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab === 'field' && showField" size="small" label-width="90px">
          <el-form-item v-if="activeData.changeTag" label="Type">
            <el-select v-model="activeData.tagIcon" placeholder="Please select component type" :style="{ width: '100%' }" @change="tagChange">
          ...
          <el-form-item v-if="activeData.placeholder !== undefined" label="Prompt">
            <el-input v-model="activeData.placeholder" placeholder="Please enter a placeholder reminder" />
          </el-form-item>
          <el-form-item v-if="activeData['start-placeholder'] !== undefined" label="Start Placeholder">
            <el-input v-model="activeData['start-placeholder']" placeholder="Please enter a placeholder reminder" />
          </el-form-item>
          <el-form-item v-if="activeData['end-placeholder'] !== undefined" label="ended placeholder">
          ...
          <el-form-item v-if="activeData.justify !== undefined && activeData.type === 'flex'" label="Horizontal">
          ...
          <el-form-item v-if="activeData.align !== undefined && activeData.type === 'flex'" label="Vertical">
          ...
          <el-form-item v-if="activeData.style && activeData.style.width !== undefined" label="Width">
            <el-input v-model="activeData.style.width" placeholder="Please enter the component width" clearable />
          </el-form-item>
          <el-form-item v-if="activeData.vModel !== undefined" label="Value">
            <el-input :value="setDefaultValue(activeData.defaultValue)" placeholder="Please enter the default value" @input="onDefaultValueInput" />
          </el-form-item>
          <el-form-item v-if="activeData.tag === 'el-checkbox-group'" label="At least selected">
            <el-input-number :value="activeData.min" :min="0" placeholder="At least selected" @input="$set(activeData, 'min', $event ? $event : undefined)" />
          </el-form-item>
          <el-form-item v-if="activeData.tag === 'el-checkbox-group'" label="maximum optional">
            <el-input-number :value="activeData.max" :min="0" placeholder="At most optional" @input="$set(activeData, 'max', $event ? $event : undefined)" />
          </el-form-item>
          ...
          <el-form-item v-if="activeData.append !== undefined" label="Postfix">
            <el-input v-model="activeData.append" placeholder="Please enter the suffix" />
          </el-form-item>
          <el-form-item v-if="activeData['prefix-icon'] !== undefined" label="icon">
            <el-input v-model="activeData['prefix-icon']" placeholder="Please enter the name of the former icon">
              <el-button slot="append" icon="el-icon-thumb" @click="openIconsDialog('prefix-icon')"> select </el-button>
            </el-input>
          </el-form-item>
          <el-form-item v-if="activeData['suffix-icon'] !== undefined" label="Back icon">
            <el-input v-model="activeData['suffix-icon']" placeholder="Please enter the name of the icon">
              <el-button slot="append" icon="el-icon-thumb" @click="openIconsDialog('suffix-icon')"> select </el-button>
            </el-input>
          </el-form-item>
          ...
          <el-form-item v-if="activeData.autosize !== undefined" label="Minimum number of rows">
            <el-input-number v-model="activeData.autosize.minRows" :min="1" placeholder="minimum number of rows" />
          </el-form-item>
          <el-form-item v-if="activeData.autosize !== undefined" label="Maximum number of rows">
          ...
          <el-form-item v-if="activeData.step !== undefined" label="Stride">
          ...
          <el-form-item v-if="activeData['active-text'] !== undefined" label="open prompt">
            <el-input v-model="activeData['active-text']" placeholder="Please enter to open the prompt" />
          </el-form-item>
          <el-form-item v-if="activeData['inactive-text'] !== undefined" label="Close prompt">
            <el-input v-model="activeData['inactive-text']" placeholder="Please enter to close the prompt" />
          </el-form-item>
          <el-form-item v-if="activeData['active-value'] !== undefined" label="Open value">
            <el-input :value="setDefaultValue(activeData['active-value'])" placeholder="Please enter the opening value" @input="onSwitchValueInput($event, 'active-value')" />
          </el-form-item>
          <el-form-item v-if="activeData['inactive-value'] !== undefined" label="Close value">
            <el-input :value="setDefaultValue(activeData['inactive-value'])" placeholder="Please enter the closing value" @input="onSwitchValueInput($event, 'inactive-value')" />
          </el-form-item>
          <el-form-item v-if="activeData.type !== undefined && 'el-date-picker' === activeData.tag" label="Time Type">
            <el-select v-model="activeData.type" placeholder="Please select the time type" :style="{ width: '100%' }" @change="dateTypeChange">
          ...
          <el-form-item v-if="activeData.accept !== undefined" label="file type">
            <el-select v-model="activeData.accept" placeholder="Please select file type" :style="{ width: '100%' }" clearable>
          ...
          <el-form-item v-if="activeData.buttonText !== undefined" v-show="'picture-card' !== activeData['list-type']" label="Button text">
          ...
          <el-form-item v-if="activeData['picker-options'] !== undefined" label="time period">
          ...
          <el-form-item v-if="activeData.format !== undefined" label="time format">
            <el-input :value="activeData.format" placeholder="Please enter the time format" @input="setTimeValue($event)" />
          </el-form-item>
          <template v-if="['el-checkbox-group', 'el-radio-group', 'el-select'].indexOf(activeData.tag) > -1">
            ...
            <draggable :list="activeData.options" :animation="340" group="selectItem" handle=".option-drag">
              <div v-for="(item, index) in activeData.options" :key="index" class="select-item">
                ...
                <el-input placeholder="option value" size="small" :value="item.value" @input="setOptionValue(item, $event)" />
            ...
            <div style="margin-left: 20px">
              <el-button style="padding-bottom: 0" icon="el-icon-circle-plus-outline" type="text" @click="addSelectItem"> Add option </el-button>
            </div>
            <el-divider />
          </template>
          ...
          <template v-if="['el-cascader'].indexOf(activeData.tag) > -1">
            ...
            <div v-if="activeData.dataType === 'static'" style="margin-left: 20px">
              <el-button style="padding-bottom: 0" icon="el-icon-circle-plus-outline" type="text" @click="addTreeItem"> Add parent </el-button>
            </div>
            <el-divider />
          </template>
          ...
          <el-form-item v-if="activeData['show-stops'] !== undefined" label="display discontinuous points">
            <el-switch v-model="activeData['show-stops']" />
          </el-form-item>
          <el-form-item v-if="activeData.range !== undefined" label="range selection">
            <el-switch v-model="activeData.range" @change="rangeChange" />
          </el-form-item>
          <el-form-item v-if="activeData.border !== undefined && activeData.optionType === 'default'" label="Whether with border">
            <el-switch v-model="activeData.border" />
          </el-form-item>
          <el-form-item v-if="activeData.tag === 'el-color-picker'" label="color format">
            <el-select v-model="activeData['color-format']" placeholder="Please choose a color format" :style="{ width: '100%' }" @change="colorFormatChange">
              <el-option v-for="(item, index) in colorFormatOptions" :key="index" :label="item.label" :value="item.value" />
            </el-select>
          </el-form-item>
          <el-form-item v-if="activeData.size !== undefined && (activeData.optionType === 'button' || activeData.border || activeData.tag === 'el-color-picker')" label="option size">
          ...
          <el-form-item v-if="activeData['show-word-limit'] !== undefined" label="Input">
          ...
          <el-form-item v-if="activeData.tag === 'el-cascader'" label="Filtered">
            <el-switch v-model="activeData.filterable" />
          </el-form-item>
          <el-form-item v-if="activeData.clearable !== undefined" label="Cleared">
            <el-switch v-model="activeData.clearable" />
          </el-form-item>
          <el-form-item v-if="activeData.showTip !== undefined" label="display tip">
            <el-switch v-model="activeData.showTip" />
          </el-form-item>
          <el-form-item v-if="activeData.multiple !== undefined" label="Multi-select file">
          ...
          <el-form-item v-if="activeData.tag === 'el-select'" label="Whether multiple selections">
          ...
          <template v-if="activeData.layout === 'colFormItem'">
            ...
            <div v-for="(item, index) in activeData.regList" :key="index" class="reg-item">
              ...
              <el-form-item label="Error notification" style="margin-bottom: 0">
                <el-input v-model="item.message" placeholder="Please enter an error message" />
              </el-form-item>
            </div>
            <div style="margin-left: 20px">
              <el-button icon="el-icon-circle-plus-outline" type="text" @click="addReg"> Add rule </el-button>
            </div>
          </template>
        </el-form>
        <!-- Form attributes -->
...
export default {
  ...
  computed: {
    documentLink() {
      return this.activeData.document || 'https://element.eleme.io/#/en-US/component/installation'
    },
    dateOptions() {
  ...
  methods: {
      ...
      return (
        <div class='custom-tree-node'>
          ...
          <span class='node-operation'>
            <i on-click={() => this.append(data)} class='el-icon-plus' title='add'></i>
            <i on-click={() => this.remove(node, data)} class='el-icon-delete' title='Delete'></i>
          </span>
        </div>
      )
    },
    ...
    colorFormatChange(val) {
      ...
      this.activeData.renderKey = +new Date() // Update the renderKey and re-render the component
    },
