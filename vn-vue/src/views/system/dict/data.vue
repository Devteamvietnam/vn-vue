<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="Dictionary coding" align="center" prop="dictCode" />
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        dictLabel: [
          { required: true, message: 'Data tag cannot be empty', trigger: 'blur' }
        ],
        dictValue: [
          { required: true, message: 'Data key value cannot be empty', trigger: 'blur' }
        ],
        dictSort: [
          { required: true, message: 'Data sequence cannot be empty', trigger: 'blur' }
        ]
      }
    }
  },
