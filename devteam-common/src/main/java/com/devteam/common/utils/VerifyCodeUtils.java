...
{
    // Use Algerian font. If there is no font in the system, you need to install the font. The font only displays uppercase, and the 1,0,i,o characters that are easy to be confused are removed
    public static final String VERIFY_CODES = "123456789ABCDEFGHJKLMNPQRSTUVWXYZ";

    private static Random random = new SecureRandom();

    /**
     * Use system default character source to generate verification code
     *
    ...
    /**
     * Use specified source to generate verification code
     *
     * @param verifySize verification code length
    ...
    public static void outputImage(int w, int h, OutputStream os, String code) throws IOException
    {
        ...
        shear(g2, w, h, c);// Make the picture distorted
