package com.devteam.common.utils.reflect;
...
public class ReflectUtils
{
    ...
    /**
     * Call the Setter method, only the method name is matched.
     * Support multiple levels, such as: object name. object name. method
     */
    ...
    /**
     * Read object property values ​​directly, ignoring private/protected modifiers, without passing through getter functions.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Directly set object property values, ignoring private/protected modifiers, and not passing through setter functions.
     */
    ...
    /**
     * Directly call object methods, ignoring private/protected modifiers,
     * Used in the case of one-time call, otherwise, you should use getAccessibleMethodByName() to get the Method and call it repeatedly.
    ...
    public static <E> E invokeMethodByName(final Object obj, final String methodName, final Object[] args)
    {
        ...
        if (method == null)
        {
            // If it is empty and no error is reported, it will return empty directly.
            logger.debug("In [" + obj.getClass() + "], [" + methodName + "] method was not found ");
            return null;
        }
        try
     ...
     * Used when the method needs to be called multiple times. Use this function to get the Method first, then call Method.invoke(Object obj, Object... args)
     */
    ...
    /**
     * Change the private/protected member variable to public, try not to call the actually changed statement, to avoid complaints from the JDK SecurityManager.
     */
