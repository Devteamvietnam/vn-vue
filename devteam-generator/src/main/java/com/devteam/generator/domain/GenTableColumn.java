package com.devteam.generator.domain;
...
public class GenTableColumn extends BaseEntity
{
    ...
    /** JAVA field name */
    @NotBlank(message = "Java property cannot be empty")
    ...
    /** Is it an insert field (1 is) */
    private String isInsert;

    /** Whether to edit the field (1 is) */
    private String isEdit;

    /** Whether to list field (1 is) */
    ...
    /** Display type (input text box, textarea text field, select drop-down box, checkbox checkbox, radio radio button, datetime date control, upload upload control, editor rich text control) */
