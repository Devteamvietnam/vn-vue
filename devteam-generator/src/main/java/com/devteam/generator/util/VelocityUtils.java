...
public class VelocityUtils
{
    ...
    /** The default upper-level menu, system tools */
    ...
    /**
     * Obtain the import package according to the column type
     *
     ...
     * @return returns the permission prefix
     */
    ...
    /**
     * Get the upper menu ID field
     *
     * @param paramsObj generates other options
     * @return superior menu ID field
     */
