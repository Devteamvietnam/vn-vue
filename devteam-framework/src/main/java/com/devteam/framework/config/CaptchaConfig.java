...
public class CaptchaConfig
{
    ...
    public DefaultKaptcha getKaptchaBean()
    {
        ...
        // The color of the verification code text character is Color.BLACK by default
    ...
    public DefaultKaptcha getKaptchaBeanMath()
    {
        ...
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, "com.devteam.framework.config.KaptchaTextCreator");
