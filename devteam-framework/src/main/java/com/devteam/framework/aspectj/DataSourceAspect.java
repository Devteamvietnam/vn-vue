...
import com.devteam.framework.datasource.DynamicDataSourceContextHolder;
...
public class DataSourceAspect
{
    ...
    @Pointcut("@annotation(com.devteam.common.annotation.DataSource)"
            + "|| @within(com.devteam.common.annotation.DataSource)")
